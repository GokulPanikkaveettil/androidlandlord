...
class UserRegister : AppCompatActivity() {
    ...
    private suspend fun addNewUser(firstName: String,lastName: String,userName: String,password: String, gender: String
    ...
    fun validateInput(firstName: String,lastName: String,userName: String,password: String, gender: RadioGroup): Boolean {
        val selectedGenderGroup = gender.checkedRadioButtonId
